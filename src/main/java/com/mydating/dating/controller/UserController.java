...
public class UserController {
	...
	@GetMapping("/users/search/email/{emailLetters}")
	public ResponseEntity<?> searchByEmail(@PathVariable String emailLetters){
		return userService.searchByEmail(emailLetters);
	}
